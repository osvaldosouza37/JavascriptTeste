...
function media(){
    ...
    document.getElementById('resultado').innerText = ` A média dos três números é: ${media}`;
...
function imc(){
    ...
    document.querySelector('#resultado').innerHTML = `<p>${nome} seu IMC é: ${imc}</p>`;

}

function multiplos(){

    let numero = 1,somador=0,teste=false;
...
function fibonacci(){
    ...
    let a=1,b=0,c=0,pares = [],fib = [],somador=0;
...
function inverte(){
    ...
    let vetor = [1,2,3,4,5,6],invetor = [],contador=0;
